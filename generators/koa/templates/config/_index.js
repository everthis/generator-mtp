...
const nodeDevSocket = path.resolve(__dirname, '../shared/sockets/node.dev.sock')
const nodeProdSocket = path.resolve(
    __dirname,
    '../shared/sockets/node.prod.sock'
)
const nodeSocket = isProd ? nodeProdSocket : nodeDevSocket
const nodePidPath = path.resolve(__dirname, '../shared/pids/node.pid')
